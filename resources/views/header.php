        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
            <div class="flex items-center gap-8">
                <a href="/" class="flex" title="<?=APP_NAME?>">
                    ...
                    <img class="h-10 w-auto sm:h-10" width="500" src="<?= base_url('/imgs/kanata.png') ?>" alt="<?=APP_NAME?>">
                </a>
            </div>
            ...
            <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
                ...
                <?php
                /**
                 * Filter: header_navbar_menus
                 * Description: Add items to header menu.
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            <div class="pt-5 pb-6 px-5 sm:pb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <img class="h-8 w-auto sm:h-10" src="<?= base_url('/imgs/kanata.png') ?>" alt="<?=APP_NAME?>">
                    </div>
                    <div class="-mr-2">
            ...
            <div class="py-6 px-5">
                ...
                <?php
                /**
                 * Filter: header_navbar_menus_mobile
                 * Description: Add items to header menu.
                 * Expected return: array
                 * @param array Items to be added to menu.
                 */
